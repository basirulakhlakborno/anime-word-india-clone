...
function Series() {
  ...
  // Fetch posts - only series
  useEffect(() => {
    const fetchPosts = async () => {
      setIsLoading(true);
      
      try {
        const response = await api.getCategory('series', currentPage);
  ...
  return (
    <>
      <Helmet>
        <title>Series - Anime World India</title>
        <meta name="description" content="Browse Series on Anime World India" />
      </Helmet>
