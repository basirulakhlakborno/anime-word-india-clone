...
import './NewAnimeArrivals.css';

function NewAnimeArrivals({ title = 'New Anime Arrivals', series = [] }) {
  ...
  useEffect(() => {
    ...
    const initializeSwiper = () => {
      if (swiperContainerRef.current && window.Swiper) {
        ...
        setTimeout(() => {
          const images = document.querySelectorAll('#widget_list_movies_series-2 .latest-movies-series-swiper-slide img');
          const spidercatContainers = document.querySelectorAll('#widget_list_movies_series-2 .spidercat-container-sp25');
  ...
  return (
    <section id="widget_list_movies_series-2" className="wdgt-home widget section widget_list_movies_series movies">
          ...
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide">
              <div className="spidercat-container-sp25">
                ...
                <a
                  href="/category/type/anime/?type=series"
                  className="view-more-btn-sp25"
                  onClick={(e) => {
                    e.preventDefault();
                    navigate('/category/type/anime/?type=series');
                  }}
                >
                  View More
                </a>
