...
import '../FreshCartoonFilms/FreshCartoonFilms.css';
import './LatestAnimeMovies.css';

function LatestAnimeMovies({ title = 'Latest Anime Movies', movies = [] }) {
  ...
  return (
    <section id="widget_list_movies_series-4" className="wdgt-home widget section widget_list_movies_series movies">
          ...
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide">
              <div className="spidercat-container-sp25">
                ...
                <a
                  href="/category/type/anime/?type=movies"
                  className="view-more-btn-sp25"
                  onClick={(e) => {
                    e.preventDefault();
                    navigate('/category/type/anime/?type=movies');
                  }}
                >
                  View More
                </a>
...
export default LatestAnimeMovies;
